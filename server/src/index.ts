...
import paymentPrepareRouter from "./routes/payment/prepare.js";
...
import cronMetaAdsReportRouter from "./routes/cron/meta-ads-report.js";
...
app.use("/api/payment/prepare", paymentPrepareRouter);
...
app.use("/api/cron/meta-ads-report", cronMetaAdsReportRouter);
