...
const StudentsWorks: React.FC = () => {
    ...
    const videos = [
        {id: "01", duration: "0:18", tag: "ADS"},
        {id: "02", duration: "0:12", tag: "EDITORIAL"},
        {id: "03", duration: "0:25", tag: "FILM"},
        {id: "04", duration: "0:14", tag: "SOCIAL"},
    ];
                        ...
                        {videos.map((video) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-zinc-800 flex items-center justify-center">
                                    ...
                                    {/* Play Button */}
                                    <div
                                        className="w-16 h-16 rounded-full border-2 border-white/30 flex items-center justify-center group-hover/card:border-purple-500 group-hover/card:bg-purple-500/10 transition-all">
                                ...
                                <div className="absolute top-3 left-3 flex gap-2 z-10">
                                    <div
                                        className="bg-purple-600 text-white px-2 py-1 font-brutal text-[10px] uppercase animate-pulse">
                                        REC ●
                                    </div>
                                </div>
                                ...
                                {/* Bottom info */}
                                <div
                                    className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black to-transparent flex justify-between items-end">
                                    <div className="flex flex-col">
                                        <p className="text-[12px] font-bold text-purple-500 uppercase">
                                            STUDENT PROJECT
                                        </p>
                                    </div>
                                </div>
