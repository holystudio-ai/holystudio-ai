...
const Team: React.FC = () => {
    ...
    const videoWorks = [
        { id: '01', videoId: 'xNfiBxSdNIk', title: 'AMIC', caption: 'AMIC', tag: 'РЕКЛАМНИЙ РОЛИК' },
            ...
            <div className="mx-auto flex max-w-7xl flex-col items-center">
                <div className="mb-10 w-full md:mb-16">
                    <div className="relative w-full overflow-hidden border-2 border-zinc-800 bg-black">
                        ...
                        <div className="relative z-10 flex w-full flex-col items-center justify-center gap-6 px-4 pb-3 pt-12 md:gap-10 md:py-20">
                    ...
                    <div className="relative mt-8 flex flex-col gap-8 border-2 border-zinc-800 bg-zinc-900 p-4 md:gap-10 md:p-10">
                        ...
                        <div className="logo-marquee group relative overflow-hidden border-2 border-zinc-800 bg-black/60 px-0 py-4 md:py-5">
                            <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12 bg-gradient-to-r from-zinc-900 via-zinc-900/75 to-transparent md:w-24" />
                            <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12 bg-gradient-to-l from-zinc-900 via-zinc-900/75 to-transparent md:w-24" />
                        ...
                        {instructors.map((ins, idx) => (
                            ...
                            >
                                <div className="flex items-start gap-5">
                                    <div className="relative h-[140px] w-[140px] shrink-0 overflow-hidden border-purple-500 min-[480px]:h-[170px] min-[480px]:w-[160px] md:h-[220px] md:w-[200px] brutalist-border">
                                        <img
                                            src={ins.image}
                                            alt={ins.name}
                ...
                <div className="mt-12 px-4 text-center md:mt-20">
                    <div className="inline-block border-black bg-white p-4 font-brutal text-sm font-black uppercase text-black md:p-6 md:text-2xl brutalist-border brutalist-shadow-accent">
